...
input bool OpenNurbeiNeuemBar=true; // Sollen nur Orders bei neuem Bar ge�ffnet werden?
...
// ---------------- Kerze 3 ...
   upOrdown=einAustiegKursBerechnen(2); //steigt oder f�llt die 3. Kerze?
...
// ---------------- Kerze 2 ...
   upOrdown=einAustiegKursBerechnen(1); //steigt oder f�llt die 2. Kerze?
   if(Kerzensignal=="BUY")
     {
   ...
   if(Bars<barsInnenstaebe) // es werden soviele Bars muessen min. im Chart sein um die Innenstaebe zu bestimmen
     {
      ...
      // Ausführung beenden wenn kein neuer BAR
   ...
   switch(Tip) // By order type
     {
         ...
         if(Bid-modifySL<Min_Dist) // If less than allowed
           {
            ...
            Print("Bid:"+Bid+"-modifySL:"+modifySL+"="+test+"<Min_Dist:"+Min_Dist+"  Mindestabstand nicht erreicht. SL kann nicht ge�ndert werden.");
            Modify=false;
           }
      ...
      case 1 :                // SELL ORDER
         ...
         if(modifySL-Ask<Min_Dist) // If less than allowed
           {
            test=modifySL-Ask;
            Print("Ask:"+Ask+"-modifySL:"+modifySL+"="+test+"<Min_Dist:"+Min_Dist+"  Mindestabstand nicht erreicht. SL kann nicht ge�ndert werden.");
            Modify=false;
           }
